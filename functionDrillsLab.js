...
//this will still bring up 10 in the console logs
...
//Syntax is a declaration function
...
console.log(nameGreeting) // 'What is up Steven?' would show up if 
...
let answer = bestMovie('John Carpenters The Thing')
console.log(answer)
...
let arrayEvaluater = bigOrSmall(bigOrSmallArray)
